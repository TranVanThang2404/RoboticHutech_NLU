"""Test chi chay banh trai de kiem tra huong quay va do manh cua banh trai.

Mac dinh:
  - Dem nguoc 3 giay
  - Chi gui lenh tien cho banh trai
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Test chi chay banh trai."
    )
...
def main() -> int:
    ...
    try:
        ...
        print(f"[TEST] Gui lenh: L=+{speed}, R=0")
        if not motor.send(speed, 0, apply_compensation=False):
